...
- Registro de decisiones arquitectónicas (ADRs 001-029) migrado a formato MADR individual en `adr/` (una decisión por archivo), reemplazando el monolítico `DECISIONS.md` (ADR-025)
- **Nivel MVP de auditoría (4 ADRs críticos faltantes):**
