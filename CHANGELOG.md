...
- Registro de decisiones arquitectónicas (ADRs 001-030) migrado a formato MADR individual en `adr/` (una decisión por archivo), reemplazando el monolítico `DECISIONS.md` (ADR-025)
