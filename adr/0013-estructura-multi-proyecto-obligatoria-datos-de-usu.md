...
**Status:** ✅ Decidido para la **fase 1** (aislamiento de `USER_INPUT/`, `reports/output/` y estado); el aislamiento del **MCP por proyecto queda pospuesto** (ver "Cuestión abierta" abajo).
