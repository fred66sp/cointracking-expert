...
- ADR-022: Tercera pata de vigencia — contexto regulatorio/operativo de exchanges (extiende ADR-008) ✅ Decidido
- ADR-023: El MCP es dueño del ciclo de vida de sus archivos de caché (`cointracking_delete_project`) ✅ Decidido
- ADR-024: Formato "bloque-resumen" obligatorio al guiar altas/correcciones manuales en CoinTracking ✅ Decidido
- ADR-025: Formatos "CT-List" para mostrar listas de operaciones/hallazgos en la conversación ✅ Decidido
